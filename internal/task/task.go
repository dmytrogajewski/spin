...
const (
	// TaskNameRegular defines a task type constant.
	TaskNameRegular = "regular"
	// TaskNameReview defines a task type constant.
	TaskNameReview = "review"
	// TaskNameCompact defines a constant.
	TaskNameCompact = "compact"
	// TaskNamePlanning defines a constant.
	TaskNamePlanning = "planning"
)

var (
	// ErrUnknownTask is a sentinel error.
	ErrUnknownTask = errors.New("unknown task")
	// ErrInvalidTaskMode is a sentinel error.
	ErrInvalidTaskMode = errors.New("invalid task mode")
	// ErrMaxTokensMustBePositive is a sentinel error.
	ErrMaxTokensMustBePositive = errors.New("max tokens must be positive")
	// ErrMaxTokensExceedsMaximumAllowed is a sentinel error.
