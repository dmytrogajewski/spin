...
func NewGitOperationTool(gitIntegration *GitIntegration) *GitOperationTool {
...
func gitSuccessResult(output string) tools.ToolResult {
...
func gitErrorResult(msg string) tools.ToolResult {
	return tools.ToolResult{
		Success: false,
		Error:   msg,
	}
...
func handleGitCommit(ctx context.Context, t *GitOperationTool, params map[string]interface{}) (tools.ToolResult, error) {
...
func handleGitPush(ctx context.Context, t *GitOperationTool, params map[string]interface{}) (tools.ToolResult, error) {
...
func handleGitPull(ctx context.Context, t *GitOperationTool, params map[string]interface{}) (tools.ToolResult, error) {
...
func handleGitCreateBranch(ctx context.Context, t *GitOperationTool, params map[string]interface{}) (tools.ToolResult, error) {
...
func handleGitSwitchBranch(ctx context.Context, t *GitOperationTool, params map[string]interface{}) (tools.ToolResult, error) {
	branchName, _ := params["branch_name"].(string)
	if branchName == "" {
...
func handleGitListBranches(ctx context.Context, t *GitOperationTool, params map[string]interface{}) (tools.ToolResult, error) {
...
func handleGitListRemotes(ctx context.Context, t *GitOperationTool, params map[string]interface{}) (tools.ToolResult, error) {
...
func handleGitStatus(ctx context.Context, t *GitOperationTool, params map[string]interface{}) (tools.ToolResult, error) {
...
func handleGitDiff(ctx context.Context, t *GitOperationTool, params map[string]interface{}) (tools.ToolResult, error) {
	filePath, _ := params["file_path"].(string)
...
func handleGitLog(ctx context.Context, t *GitOperationTool, params map[string]interface{}) (tools.ToolResult, error) {
	limit := 10
...
func (t *GitOperationTool) Schema() tools.ToolSchema {
