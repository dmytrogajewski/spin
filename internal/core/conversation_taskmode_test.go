...
func TestConversation_TaskMode_PersistsAcrossTurns(t *testing.T) {
	// Create a conversation with a mock LLM that completes immediately
...
// setupTestConversation creates a test conversation with all dependencies.
func setupTestConversation(t *testing.T) *Conversation {
	t.Helper()
