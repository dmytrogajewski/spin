...
func TestExecuteShellCommand_Disabled(t *testing.T) {
	logger := slog.New(slog.NewTextHandler(os.Stderr, &slog.HandlerOptions{Level: slog.LevelError}))
	integration := NewShellIntegration(false, "/tmp", logger, 30*time.Second)
...
func TestExecuteShellCommand_Timeout(t *testing.T) {
	...
	integration := NewShellIntegration(true, "/tmp", logger, 1*time.Second)
...
func TestExecuteShellCommand_CustomTimeout(t *testing.T) {
	...
	integration := NewShellIntegration(true, "/tmp", logger, customTimeout)
...
func TestExecuteShellCommand_ContextTimeout(t *testing.T) {
	...
	integration := NewShellIntegration(true, "/tmp", logger, 10*time.Second)
...
func TestExecuteShellCommand_ZeroTimeout(t *testing.T) {
	...
	integration := NewShellIntegration(true, "/tmp", logger, 0)
