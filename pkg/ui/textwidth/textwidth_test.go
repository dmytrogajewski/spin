...
func TestGutterWidth(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "single_digit", lineCount: 5, want: width3},
		{name: "double_digit", lineCount: 50, want: width4},
		{name: "triple_digit", lineCount: 500, want: width5},
		{name: "four_digit", lineCount: 5000, want: width6},
		{name: "zero", lineCount: 0, want: width3},
	}
